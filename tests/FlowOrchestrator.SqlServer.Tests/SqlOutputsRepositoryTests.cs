...
public sealed class SqlOutputsRepositoryTests : IClassFixture<SqlServerFixture>
{
    private readonly SqlOutputsRepository _repo;

    public SqlOutputsRepositoryTests(SqlServerFixture fixture)
    {
        _repo = new SqlOutputsRepository(fixture.ConnectionString);
    }
